...
{
	private var title_tf: NESTextField;
	...
	{
		registerClass("__Packages.ua.com.syo.battlecity.screens.Preloader", Preloader);
		var instance: MovieClip = clip.attachMovie("__Packages.ua.com.syo.battlecity.screens.Preloader", name, depth, initObject);
	...
	{
		this.title_tf = NESTextField.create(this, "title_tf", this.getNextHighestDepth());
	...
	{
		this.title_tf.init(82, 96, DataLabels.PRELOADER_TITLE, 0xFFFFFF);
